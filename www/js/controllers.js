...
.controller('MainController', ["TaskService", "$ionicLoading", "$rootScope", "$state", "$scope", function(TaskService, $ionicLoading, $rootScope, $scope, $state) {
      var vm = this;
      ...
      .controller('ItemController', ["TaskService", "$ionicLoading", "$rootScope", "$state", "$stateParams", function(TaskService, $ionicLoading, $rootScope, $state, $stateParams) {
            var vm = this;

              console.log($stateParams.id);
            TaskService.getProductById($stateParams.id).then(function(response) {
              $rootScope.current = response.data[0];
